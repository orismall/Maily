    ...
    public class ComposeMailActivity extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            if (isReply) {
                ...
                String replySubject = originalSubject != null && originalSubject.startsWith("Re:")
                        ? originalSubject
                        : "Re: " + (originalSubject != null ? originalSubject : "");
                etSubject.setText(replySubject);

                String separator = "-----------------------------";
                String fromLine = "From: " + (originalSender != null ? originalSender : "Unknown");
                String subjectLine = "Subject: " + (originalSubject != null ? originalSubject : "");
                String quotedBody = originalBody != null ? originalBody : "";

                String fullReplyText = "\n\n" + separator + "\n" + fromLine + "\n" + subjectLine + "\n\n" + quotedBody;

                etBody.setText(fullReplyText);
            }else if (isForward) {
                String originalSubject = intent.getStringExtra("originalSubject");
                String originalBody = intent.getStringExtra("originalBody");
